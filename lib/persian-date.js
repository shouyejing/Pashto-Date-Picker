...
var monthRange = {
    ...
    persianDaysName = ["اورمزد", "سلواغه", "اورمرغومیبهشت", "وږی", "سپندارمذ", "خورداد", "زمری", "مرغومی به آذز", "آذز", "لړم", "خورشید", "ماه", "چنګاښ", "گوش", "مرغومی به تله", "تله", "سروش", "رشن", "وری", "بهرام", "رام", "باد", "مرغومی به مرغومین", "مرغومین", "ارد", "اشتاد", "آسمان", "زامیاد", "مانتره سپند", "انارام", "زیامرغومی"];
