...
var ClassDateRange = {
     ...
     */
    persianDaysName: ["اورمزد", "سلواغه", "اورمرغومیبهشت", "وږی", "سپندارمذ", "خورداد", "ازمری", "مرغومی به آذز", "آذز", "لړم", "خورشید", "ماه", "چنګاښ", "گوش", "مرغومی به تله", "تله", "سروش", "رشن", "اوری", "بهرام", "رام", "باد", "مرغومی به مرغومین", "مرغومین", "ارد", "اشتاد", "آسمان", "زامیاد", "مانتره سپند", "انارام", "زیامرغومی"]
};
...
var ClassDatepicker = {
	...
	if(self.currentView == 'day'){
            self.element.main.hide();
	    document.getElementByTagname("body").focus();
	}
        return this;
    },
    ...
    selectDateTime: function (unixDate) {
        var self = this;
        self.state.setSelectedDate('unix', unixDate);
        this.state.syncViewWithelected();
        switch (self.currentView) {
            case ('month'):
                self.monthPicker.selectMonth();
